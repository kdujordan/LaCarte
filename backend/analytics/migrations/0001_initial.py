    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('peak_hour', models.CharField(blank=True, max_length=5, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='MenuPopularity',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('HEAD_OF_OPERATIONS', 'Head of Operations'), ('ORDER_MANAGER', 'Order Manager')], default='ORDER_MANAGER', max_length=50)),
